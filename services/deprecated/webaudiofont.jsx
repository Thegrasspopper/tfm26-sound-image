// node_modules/webaudiofont/npm/dist/WebAudioFontPlayer.js
export var WebAudioFontChannel = (
  /** @class */
  (function() {
    function WebAudioFontChannel2(audioContext) {
    ...
    WebAudioFontChannel2.prototype.bandEqualizer = function(from, frequency) {
    ...
    ;
    return WebAudioFontChannel2;
  })()
);
export var WebAudioFontLoader = (
  /** @class */
  (function() {
    function WebAudioFontLoader2(player) {
      this.cached = [];
    ...
    WebAudioFontLoader2.prototype.startLoad = function(audioContext, filePath, variableName) {
    ...
    ;
    WebAudioFontLoader2.prototype.decodeAfterLoading = function(audioContext, variableName) {
      var me = this;
    ...
    ;
    WebAudioFontLoader2.prototype.waitOrFinish = function(variableName, onFinish) {
      if (window[variableName]) {
        onFinish();
      } else {
        var me = this;
    ...
    ;
    WebAudioFontLoader2.prototype.loaded = function(variableName) {
      if (!window[variableName]) {
        return false;
      }
    ...
    ;
    WebAudioFontLoader2.prototype.progress = function() {
    ...
    ;
    WebAudioFontLoader2.prototype.waitLoad = function(onFinish) {
      var me = this;
      if (this.progress() >= 1) {
        onFinish();
      } else {
    ...
    ;
    WebAudioFontLoader2.prototype.instrumentKeys = function() {
    ...
    ;
    WebAudioFontLoader2.prototype.instrumentInfo = function(n) {
    ...
    ;
    WebAudioFontLoader2.prototype.findInstrument = function(program) {
    ...
    ;
    WebAudioFontLoader2.prototype.drumTitles = function() {
    ...
    ;
    WebAudioFontLoader2.prototype.drumKeys = function() {
    ...
    ;
    WebAudioFontLoader2.prototype.drumInfo = function(n) {
    ...
    ;
    WebAudioFontLoader2.prototype.findDrum = function(nn) {
    ...
    return WebAudioFontLoader2;
  })()
);
console.log("WebAudioFont Engine v3.0.04 GPL3");
export var WebAudioFontPlayer = (
  /** @class */
  (function() {
    function WebAudioFontPlayer2() {
      this.envelopes = [];
    ...
    WebAudioFontPlayer2.prototype.createChannel = function(audioContext) {
      return new WebAudioFontChannel(audioContext);
    };
    ;
    WebAudioFontPlayer2.prototype.createReverberator = function(audioContext) {
      return new WebAudioFontReverberator(audioContext);
    };
    ;
    WebAudioFontPlayer2.prototype.limitVolume = function(volume) {
      if (volume) {
        volume = 1 * volume;
      } else {
        volume = 0.5;
    ...
    ;
    WebAudioFontPlayer2.prototype.queueChord = function(audioContext, target, preset, when, pitches, duration, volume, slides) {
      volume = this.limitVolume(volume);
      var envelopes = [];
      for (var i = 0; i < pitches.length; i++) {
        var singleSlide = void 0;
        if (slides) {
    ...
    ;
    WebAudioFontPlayer2.prototype.queueStrumUp = function(audioContext, target, preset, when, pitches, duration, volume, slides) {
    ...
    ;
    WebAudioFontPlayer2.prototype.queueStrumDown = function(audioContext, target, preset, when, pitches, duration, volume, slides) {
      pitches.sort(function(a, b) {
        return a - b;
      });
      return this.queueStrum(audioContext, target, preset, when, pitches, duration, volume, slides);
    ...
    ;
    WebAudioFontPlayer2.prototype.queueStrum = function(audioContext, target, preset, when, pitches, duration, volume, slides) {
      volume = this.limitVolume(volume);
    ...
    ;
    WebAudioFontPlayer2.prototype.queueSnap = function(audioContext, target, preset, when, pitches, duration, volume, slides) {
      volume = this.limitVolume(volume);
      volume = 1.5 * (volume || 1);
      duration = 0.05;
    ...
    ;
    WebAudioFontPlayer2.prototype.resumeContext = function(audioContext) {
      try {
    ...
    WebAudioFontPlayer2.prototype.queueWaveTable = function(audioContext, target, preset, when, pitch, duration, volume, slides) {
    ...
    ;
    WebAudioFontPlayer2.prototype.noZeroVolume = function(n) {
      if (n > this.nearZero) {
        return n;
      } else {
    ...
    ;
    WebAudioFontPlayer2.prototype.setupEnvelope = function(audioContext, envelope, zone, volume, when, sampleDuration, noteDuration) {
    ...
    ;
    WebAudioFontPlayer2.prototype.numValue = function(aValue, defValue) {
    ...
    ;
    WebAudioFontPlayer2.prototype.findEnvelope = function(audioContext, target) {
      var envelope = null;
      for (var i = 0; i < this.envelopes.length; i++) {
        var e = this.envelopes[i];
        if (e.target == target && audioContext.currentTime > e.when + e.duration + 1e-3) {
          try {
      ...
      if (!envelope) {
        ...
        envelope.cancel = function() {
          if (envelope && envelope.when + envelope.duration > audioContext.currentTime) {
            ...
            envelope.gain.setTargetAtTime(1e-5, audioContext.currentTime, 0.1);
            envelope.when = audioContext.currentTime + 1e-5;
            envelope.duration = 0;
          }
        };
    ...
    ;
    WebAudioFontPlayer2.prototype.findZone = function(audioContext, preset, pitch) {
      var zone = null;
    ...
    ;
    WebAudioFontPlayer2.prototype.cancelQueue = function(audioContext) {
      for (var i = 0; i < this.envelopes.length; i++) {
        var e = this.envelopes[i];
    ...
    ;
    return WebAudioFontPlayer2;
  })()
);
var WebAudioFontReverberator = (
  /** @class */
  /* @__PURE__ */ (function() {
    function WebAudioFontReverberator2(audioContext) {
      ...
      this.input.frequency.setTargetAtTime(18e3, 0, 1e-4);
      this.compressorWet.gain.setTargetAtTime(1, 0, 1e-4);
      this.compressorDry.gain.setTargetAtTime(0, 0, 1e-4);
      var threshold = -35;
      var knee = 35;
      var ratio = 8;
      var attack = 0.02;
      var release = 0.1;
      this.compressor.threshold.setValueAtTime(threshold, 1e-4);
      this.compressor.knee.setValueAtTime(knee, 1e-4);
      this.compressor.ratio.setValueAtTime(ratio, 1e-4);
      this.compressor.attack.setValueAtTime(attack, 1e-4);
      this.compressor.release.setValueAtTime(release, 1e-4);
      this.dry.gain.setTargetAtTime(0.6, 0, 1e-4);
      this.wet.gain.setTargetAtTime(0.4, 0, 1e-4);
    ...
    return WebAudioFontReverberator2;
  })()
);
var WebAudioFontTicker = (
  /** @class */
  (function() {
    function WebAudioFontTicker2() {
      this.stateStop = 1;
      this.statePlay = 2;
      this.stateEnd = 3;
    ...
    WebAudioFontTicker2.prototype.playLoop = function(player, audioContext, loopStart, loopPosition, loopEnd, queue) {
    ...
    ;
    WebAudioFontTicker2.prototype.startTicks = function(audioContext, onTick, loopStart, loopPosition, loopEnd, onEnd) {
    ...
    ;
    WebAudioFontTicker2.prototype.tick = function(audioContext, nextAudioTime, onTick, loopStart, loopPosition, loopEnd, onEnd) {
    ...
    WebAudioFontTicker2.prototype.cancel = function() {
      if (this.state == this.statePlay) {
        this.state = this.stateEnd;
      }
    };
    ;
    return WebAudioFontTicker2;
  })()
);
//# sourceMappingURL=webaudiofont.js.map
